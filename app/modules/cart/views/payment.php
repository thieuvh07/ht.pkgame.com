                    ...
                    <form class="uk-form form" method="post" action="">
                        <section class="cart-panel cart-customer">
                            ...
                            <section class="panel-body">
                                ...
                                <div class="form-row uk-flex uk-flex-middle uk-clearfix">
                                    <div class="col-1"><label>Điện thoại</label></div>
                                    <div class="col-2">
                                         <?php echo form_input('phone', set_value('phone'), 'class="" placeholder="09753006688" autocomplete="off"');?>
                                        <div class="bg-loader"></div>
                                        <button type="button" class="uk-button btn-otp">Nhận Mã OTP</button>
                                ...
                                <div class="form-row uk-clearfix" style="margin-bottom: 0px" >
                                    <?php echo show_flashdata_frontend(); ?>
                                    <div class="otp uk-alert uk-hidden" data-otp></div>
                                </div>
                                ...
                                <div class="form-row uk-clearfix">
                                    ...
                                    <div class="col-2">
                                        <input type="text" name="otp_code" value="" class="text uk-width-1-1" placeholder="Mã OTP (gồm 6 chữ số)" />
                                    </div>
                                </div>
                                <script>
                                    $(document).on('click','.btn-otp',function(){
                                        ...
                                        let otpAlert = $('.otp[data-otp]');
                                        
                                        $('.bg-loader').show();
                                        //phải nhập số điện thoại để tiếp tục
                                        if(phone == ''){
                                            alert('Bạn phải nhập SỐ ĐIỆN THOẠI để thực hiện chức năng này');
                                        }else{
                                            $.ajax({
                                                url: 'cart/ajax/cart/send_otp',
                                                type: 'POST',
                                                dataType: 'json',
                                                data: {
                                                    phone: phone,
                                                ...
                                                success: function(data){
                                                    ...
                                                    if(data.error.flag == 1){
                                                        otpAlert.removeClass('uk-alert-success');
                                                        otpAlert.removeClass('uk-hidden');
                                                        otpAlert.addClass('uk-alert-danger');
                                                        otpAlert.html(data.error.message);
                                                    }else{
                                                        otpAlert.addClass('uk-alert-success');
                                                        otpAlert.removeClass('uk-hidden');
                                                        otpAlert.removeClass('uk-alert-danger');
                                                        otpAlert.html(data.error.message);
                                                    }
                                                }
                                            })
